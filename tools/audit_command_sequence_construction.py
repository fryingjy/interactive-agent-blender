...
def audit_sequence(sequence: list[dict[str, Any]], primary_names: list[str]) -> dict[str, Any]:
    ...
    for step in sequence:
        ...
        if command in {"create_primitive", "create_curve", "create_revolved_profile", "create_profile_extrusion", "create_profile_loft"}:
    ...
    for name in primary_names:
        ...
        connected_profile = origin in {"create_revolved_profile", "create_profile_extrusion", "create_profile_loft"}
