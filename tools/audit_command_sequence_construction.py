...
def audit_sequence(sequence: list[dict[str, Any]], primary_names: list[str]) -> dict[str, Any]:
    ...
    for step in sequence:
        ...
        if command in {"create_primitive", "create_curve", "create_revolved_profile", "create_profile_extrusion", "create_profile_loft", "create_quad_shell_grid", "create_quad_shell_sections", "create_quad_open_surface", "create_quad_annular_shell", "create_quad_layered_annular_shell", "create_authored_quad_mesh", "create_quad_radial_surface"}:
    ...
    for name in primary_names:
        ...
        connected_profile = origin in {"create_revolved_profile", "create_profile_extrusion", "create_profile_loft", "create_quad_shell_grid", "create_quad_shell_sections", "create_quad_open_surface", "create_quad_annular_shell", "create_quad_layered_annular_shell", "create_authored_quad_mesh", "create_quad_radial_surface"}
