...
| General reference-workflow video study | seven user-supplied public videos analyzed through reproducible Gemini 3.6 audio/visual input; purpose-scoped synthesis now drives typed research questions, candidate rejection, retrieval, planner provenance, and strict stage gating on the Bialetti board | one bounded reference-policy skill runtime validated; human review and equal-budget modeling transfer pending |
