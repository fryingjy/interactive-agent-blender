...
| Hard-surface shading policy | semantic bevel-weight typed operations; Blender 5.2 Bevel/SubD/Smooth-by-Angle lab; matched flat-panel comparison measuring plain smooth Bevel at 10.5605° normal error versus 0° for Harden Normals and Face Strength → Weighted Normal; fresh-process checks and solid Workbench evidence | implemented for tested flat manufactured forms; sharp intent and curved/non-planar surface repair still require reference/topology judgment |
