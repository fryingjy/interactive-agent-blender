...
| Retopology foundations | official planning/live lessons; sculpt handoff; analytic density/pole tests; actual two-bone weighted organic joint with 6.28× sparse/purposeful error ratio | planning/density/pole/joint-weight mechanism evidence complete; rigged facial pose transfer remains |
