...
| Hard-surface shading policy | semantic bevel-weight typed operations; explicit declaration separated from assignment; Blender 5.2 Bevel/SubD/Smooth-by-Angle lab; matched flat-panel and radial normal comparisons; crown/saddle connected-quad transfer with eight-edge omission controls, MatCap evidence, live unapplied stacks, and fresh verification | implemented for tested flat, radial, and controlled double-curvature manufactured cases; technical cleanliness no longer hides incomplete edge maps, while reference-driven sharp intent and unfamiliar-asset recovery remain open |
