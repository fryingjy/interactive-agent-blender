...
The most credible future gaps are evaluation and control-flow gaps, not another geometry module:
...
None of these were implemented during consolidation. Each requires a separate hypothesis,
acceptance metric, and regression experiment before it can enter the authoritative path.
