# Benchmark and implementation history

This is the project's chronological engineering record, preserved from the original long-form
README. It documents earlier milestones, failures, corrections, and historical claims. For the
current project state and navigation, start with the repository-root `README.md`; current evidence
and code override stale statements in this history.
