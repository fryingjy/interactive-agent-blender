...
| Reference uncertainty and source provenance | question-driven policy, source-retention ledger, source audit, and current official Swingline gallery/specification records | Implemented and bounded; the underside remains explicitly deferred |
